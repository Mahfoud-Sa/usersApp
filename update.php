...
$sql = "
UPDATE `users` SET `name` = '$usrName', `password` = '$usrPassword', `fullName` = '$fullName', `email` = '$email', `phoneNum` = '$phoneNum', `address` = '$address', `idNumCard` = '$idNumCard' WHERE `users`.`id` = $userID; 
"
;
//echo $sql;
